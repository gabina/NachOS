...
private:
    ...
    /// Sem
    Semaphore* sem;
    /// Guarda el hilo que posee el lock
    Thread* threadLocker;    
    /// Guarda el thread que hizo inversión de prioridades con el threadLocker
...
private:
    ...
    /// Lista de semáforos. Uno para cada thread que esté durmiendo.
